...
function renderTodoList() {
  // If no data in 'data' object, then just return
  ...
  // Looping through completed list
...
//   let ul = document.getElementById('completed');

//   let div = document.createElement('div');
//   div.classList.add('clearLink');
//   ul.parentNode.appendChild(div);

//   let link = document.createElement('a');
//   link.setAttribute('href', '#');
//   link.innerText = 'Clear completed list';
//   div.appendChild(link);
// }
// createClearLink();

// function clearCompletedList() {
//   let link = document.querySelector('.clearLink a');
